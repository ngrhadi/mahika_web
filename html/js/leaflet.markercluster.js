  ...
  (L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        ? this._map
          ? e.__parent
            ? (this._unspiderfy && (this._unspiderfy(), this._unspiderfyLayer(e)),
              ...
              this)
            : this
          : (!this._arraySplice(this._needsClustering, e) && this.hasLayer(e) && this._needsRemoving.push(e), this)
    ...
    addLayers: function (e) {
      ...
      if (this._map) {
        ...
        for (var d = this._needsClustering; a > h; h++)
          (t = e[h]), t instanceof L.LayerGroup ? (u && ((e = e.slice()), (u = !1)), this._extractNonGroupLayers(t, e), (a = e.length)) : t.getLatLng ? this.hasLayer(t) || d.push(t) : n.addLayer(t);
      return this;
    },
        ...
        for (t = 0; n > t; t++)
          (i = e[t]),
            i instanceof L.LayerGroup
              ...
              : (this._arraySplice(this._needsClustering, i), r.removeLayer(i), this.hasLayer(i) && this._needsRemoving.push(i));
        return this;
      }
      if (this._unspiderfy) {
        this._unspiderfy();
      ...
      for (t = 0; n > t; t++)
        (i = e[t]),
          i instanceof L.LayerGroup
            ? (o && ((e = e.slice()), (o = !1)), this._extractNonGroupLayers(i, e), (n = e.length))
            : i.__parent
            ? (this._removeLayer(i, !0, !0), s.hasLayer(i) && (s.removeLayer(i), i.clusterShow && i.clusterShow()))
            : r.removeLayer(i);
      return (
        this._topClusterLevel._recalculateBounds(),
        this._topClusterLevel._recursivelyAddChildrenToMap(null, this._zoom, this._currentShownBounds),
    ...
    _removeLayer: function (e, t, i) {
      ...
      var a,
        h = e.__parent,
        u = h._markers;
      for (this._arraySplice(u, e); h && (h._childCount--, (h._boundsNeedUpdate = !0), !(h._zoom < 0)); )
        t && h._childCount <= 1
    ...
    _mergeSplitClusters: function () {
      ...
      this._processQueue(),
        this._zoom < e && this._currentShownBounds.intersects(this._getExpandedVisibleBounds())
          ? (this._animationStart(), this._topClusterLevel._recursivelyRemoveChildrenFromMap(this._currentShownBounds, this._zoom, this._getExpandedVisibleBounds()), this._animationZoomIn(this._zoom, e))
          : this._zoom > e
          ...
          (this._ignoreMove = !0),
            this._topClusterLevel._recursively(n, e, 0, function (r) {
              var o,
                a = r._latlng,
                h = r._markers;
              for (n.contains(a) || (a = null), r._isSingleParent() && e + 1 === t ? (s.removeLayer(r), r._recursivelyAddChildrenToMap(null, t, n)) : (r.clusterHide(), r._recursivelyAddChildrenToMap(a, t, n)), i = h.length - 1; i >= 0; i--)
    ...
    (L.MarkerCluster = L.Marker.extend({
      initialize: function (e, t, i, n) {
        L.Marker.prototype.initialize.call(this, i ? i._cLatLng || i.getLatLng() : new L.LatLng(0, 0), { icon: this }),
          (this._group = e),
          (this._zoom = t),
          (this._markers = []),
          (this._childClusters = []),
      ...
      _recursivelyRestoreChildPositions: function (e) {
        ...
        else for (var s = this._childClusters.length - 1; s >= 0; s--) this._childClusters[s]._recursivelyRestoreChildPositions(e);
      },
      ...
      _recursively: function (e, t, i, n, s) {
        var r,
          ...
          h = this._zoom;
        if (t > h) for (r = a.length - 1; r >= 0; r--) (o = a[r]), e.intersects(o._bounds) && o._recursively(e, t, i, n, s);
        else if ((n && n(this), s && this._zoom === i && s(this), i > h)) for (r = a.length - 1; r >= 0; r--) (o = a[r]), e.intersects(o._bounds) && o._recursively(e, t, i, n, s);
      },
    ...
    L.MarkerCluster.include({
      ...
      spiderfy: function () {
        if (this._group._spiderfied !== this && !this._group._inZoomAnimation) {
          ...
          this._group._unspiderfy(),
            ...
            t.length >= this._circleSpiralSwitchover ? (e = this._generatePointsSpiral(t.length, s)) : ((s.y += 10), (e = this._generatePointsCircle(t.length, s))),
      ...
      _noanimationUnspiderfy: function () {
        ...
        for (i._ignoreMove = !0, this.setOpacity(1), t = r.length - 1; t >= 0; t--)
          (e = r[t]), s.removeLayer(e), e._preSpiderfyLatlng && (e.setLatLng(e._preSpiderfyLatlng), delete e._preSpiderfyLatlng), e.setZIndexOffset && e.setZIndexOffset(0), e._spiderLeg && (n.removeLayer(e._spiderLeg), delete e._spiderLeg);
    ...
    L.MarkerCluster.include({
      _animationSpiderfy: function (e, t) {
        var n,
          ...
          g = m.opacity;
        for (
          g === i && (g = L.MarkerClusterGroup.prototype.options.spiderLegPolylineOptions.opacity), f ? ((m.opacity = 0), (m.className = (m.className || '') + ' leaflet-cluster-spider-leg')) : (m.opacity = g), l._ignoreMove = !0, n = 0;
          n < e.length;
          n++
        )
          (s = e[n]),
            ...
            _.addLayer(r),
            (s._spiderLeg = r),
            f && ((o = r._path), (a = o.getTotalLength() + 0.1), (o.style.strokeDasharray = a), (o.style.strokeDashoffset = a)),
        ...
        for (l._forceLayout(), l._animationStart(), n = e.length - 1; n >= 0; n--)
          (h = _.layerPointToLatLng(t[n])),
            ...
            f && ((r = s._spiderLeg), (o = r._path), (o.style.strokeDashoffset = 0), r.setStyle({ opacity: g }));
        this.setOpacity(0.3),
          (l._ignoreMove = !1),
          setTimeout(function () {
        ...
        for (h._ignoreMove = !0, h._animationStart(), this.setOpacity(1), i = d.length - 1; i >= 0; i--)
          (t = d[i]),
            t._preSpiderfyLatlng &&
              ...
              o && l.removeLayer(t),
              c && ((n = t._spiderLeg), (s = n._path), (r = s.getTotalLength() + 0.1), (s.style.strokeDashoffset = r), n.setStyle({ opacity: 0 })));
        (h._ignoreMove = !1),
          setTimeout(function () {
            var e = 0;
