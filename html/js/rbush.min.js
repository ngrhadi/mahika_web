  ...
  })(
    {
      1: [
        function (t, i, n) {
          'use strict';
          function e(t, i) {
            return this instanceof e ? ((this._maxEntries = Math.max(4, t || 9)), (this._minEntries = Math.max(2, Math.ceil(0.4 * this._maxEntries))), i && this._initFormat(i), void this.clear()) : new e(t, i);
          }
          function r(t, i, n) {
