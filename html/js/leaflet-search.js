  ...
  return (
    (a.Control.Search = a.Control.extend({
      ...
      options: {
        ...
        textErr: 'Nothing project there',
        textCancel: 'Cancel',
        textPlaceholder: 'Search Province',
        position: 'bottomleft',
      ...
      addTo: function (b) {
        return (
          this.options.container
            ? ((this._container = this.onAdd(b)), (this._wrapper = a.DomUtil.get(this.options.container)), (this._wrapper.style.position = 'relative'), this._wrapper.appendChild(this._container))
      ...
      _fillRecordsCache: function () {
        ...
        this._curReq && this._curReq.abort && this._curReq.abort(),
          ...
          this.options.layer
            ? ((this._recordsCache = this._recordsFromLayer()), (b = this._filterData(this._input.value, this._recordsCache)), this.showTooltip(b), a.DomUtil.removeClass(this._container, 'search-load'))
      ...
      _handleArrowSelect: function (b) {
        ...
        if (1 == b && this._tooltip.currentSelection >= c.length - 1) a.DomUtil.addClass(c[this._tooltip.currentSelection], 'search-tip-select');
          ...
          d + c[this._tooltip.currentSelection].clientHeight >= this._tooltip.scrollTop + this._tooltip.clientHeight
            ? (this._tooltip.scrollTop = d - this._tooltip.clientHeight + c[this._tooltip.currentSelection].clientHeight)
    ...
    (a.Control.Search.Marker = a.Marker.extend({
      includes: a.Mixin.Events,
      options: { icon: new a.Icon.Default(), animate: !0, circle: { radius: 10, weight: 3, color: '#e03', stroke: !0, fill: !1 } },
