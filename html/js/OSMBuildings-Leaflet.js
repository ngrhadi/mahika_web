(function (ca) {
  ...
  function va(b) {
    ...
    c = (c + g) / 4;
    e = c * c;
    for (c = 0; c < a - 1; c += 2) if (((g = S({ x: b[c], y: b[c + 1] }, d)), 0.8 > g / e || 1.2 < g / e)) return !1;
    return !0;
  }
  function ja(b, a) {
    var c = {};
  ...
  function V(b) {
    for (var a = B + p, c = v + n, d = 0, f = b.length - 3; d < f; d += 2) if (b[d] > p && b[d] < a && b[d + 1] > n && b[d + 1] < c) return !0;
    return !1;
  }
  function Ca() {
    $ ||
  ...
  var u = Math,
      ...
      function c(b) {
        ...
        switch (b.type) {
          ...
          case 'MultiPolygon':
            l = [];
            d = 0;
            for (f = b.coordinates.length; d < f; d++) (y = c({ type: 'Polygon', coordinates: b.coordinates[d] })) && l.push.apply(l, y);
            return l;
          case 'Polygon':
            b = b.coordinates;
            break;
    ...
    F = {
      ...
      addRenderItems: function (b, a) {
        for (var c, d, f, e = Ja.read(b), g = 0, h = e.length; g < h; g++)
          (c = e[g]), (f = c.id || [c.footprint[0], c.footprint[1], c.height, c.minHeight].join()), !this.loadedItems[f] && (d = this.scale(c)) && ((d.scale = a ? 0 : 1), this.items.push(d), (this.loadedItems[f] = 1));
        Ca();
      },
      scale: function (b) {
        var a = {},
        ...
        if (!(a.minHeight > ga) && ((a.footprint = this.getPixelFootprint(b.footprint)), a.footprint)) {
          ...
          ('cone' !== a.roofShape && 'dome' !== a.roofShape) || a.shape || !va(a.footprint) || (a.shape = 'cylinder');
          if (b.holes) {
            a.holes = [];
    ...
    Z = {
      ...
      _extrude: function (b, a, c, d, f, e) {
        c = q / (q - c);
        for (var g = q / (q - d), h = { x: 0, y: 0 }, k = { x: 0, y: 0 }, m, l, y = [], s = 0, t = a.length - 3; s < t; s += 2)
          (h.x = a[s] - p),
            (h.y = a[s + 1] - n),
            (k.x = a[s + 2] - p),
            (k.y = a[s + 3] - n),
            ...
            (k.x - h.x) * (m.y - h.y) > (m.x - h.x) * (k.y - h.y) &&
              ((b.fillStyle = (h.x < k.x && h.y < k.y) || (h.x > k.x && h.y > k.y) ? e : f), b.beginPath(), this._ring(b, [k.x, k.y, h.x, h.y, m.x, m.y, l.x, l.y]), b.closePath(), b.fill()),
            (y[s] = m.x),
            (y[s + 1] = m.y);
        return y;
      },
      ...
      shadow: function (b, a, c, d, f) {
        for (var e = null, g = { x: 0, y: 0 }, h = { x: 0, y: 0 }, k, m, l = 0, q = a.length - 3; l < q; l += 2)
          (g.x = a[l] - p),
            (g.y = a[l + 1] - n),
            (h.x = a[l + 2] - p),
            (h.y = a[l + 3] - n),
            ...
            (h.x - g.x) * (k.y - g.y) > (k.x - g.x) * (h.y - g.y)
              ? (1 === e && b.lineTo(g.x, g.y), (e = 0), l || b.moveTo(g.x, g.y), b.lineTo(h.x, h.y))
              : (0 === e && b.lineTo(k.x, k.y), (e = 1), l || b.moveTo(k.x, k.y), b.lineTo(m.x, m.y));
        ...
        for (var l = 0, t = a.length - 3; l < t; l += 2)
          (g.x = a[l] - p),
            ...
            (h.x - g.x) * (e.y - g.y) > (e.x - g.x) * (h.y - g.y)
              ? (1 === c && b.lineTo(g.x, g.y), (c = 0), l || b.moveTo(g.x, g.y), b.lineTo(h.x, h.y))
              : (0 === c && b.lineTo(e.x, e.y), (c = 1), l || b.moveTo(e.x, e.y), b.lineTo(m.x, m.y));
        b.closePath();
        b.fill();
      },
    },
    w = {
      draw: function (b, a, c, d, f, e, g, h, k) {
        ...
        (m = this._tangents(a, c, f, d)) ? ((e = P(m[0].y1 - a.y, m[0].x1 - a.x)), (m = P(m[1].y1 - a.y, m[1].x1 - a.x))) : ((e = 1.5 * E), (m = 1.5 * E));
        b.fillStyle = g;
        b.beginPath();
      ...
      hitArea: function (b, a, c, d, f, e, g) {
        ...
        b.fillStyle = g;
        b.beginPath();
        e ? ((g = P(e[0].y1 - a.y, e[0].x1 - a.x)), (h = P(e[1].y1 - a.y, e[1].x1 - a.x)), b.moveTo(e[1].x2, e[1].y2), b.arc(f.x, f.y, d, h, g), b.arc(a.x, a.y, c, g, h)) : (b.moveTo(a.x + c, a.y), b.arc(a.x, a.y, c, 0, 2 * E));
        b.closePath();
        b.fill();
      },
      ...
      _tangents: function (b, a, c, d) {
        ...
        if (!(h <= g * g)) {
          var h = pa(h),
            ...
            l;
          k = pa(K(0, 1 - g * g));
          for (var n = 1; -1 <= n; n -= 2) (m = f * g - n * k * e), (l = e * g + n * k * f), h.push({ x1: (b.x + a * m) << 0, y1: (b.y + a * l) << 0, x2: (c.x + d * m) << 0, y2: (c.y + d * l) << 0 });
          return h;
        }
      },
    },
    R = {
      ...
      shadow: function (b, a, c, d, f) {
        ...
        for (var h = a.length - 3; d < h; d += 2)
          (e.x = a[d] - p), (e.y = a[d + 1] - n), (g.x = a[d + 2] - p), (g.y = a[d + 3] - n), f && ((e = z.project(e, f)), (g = z.project(g, f))), (g.x - e.x) * (c.y - e.y) > (c.x - e.x) * (g.y - e.y) && this._triangle(b, e, g, c);
      },
      ...
      hitArea: function (b, a, c, d, f, e) {
        ...
        for (var k = a.length - 3; e < k; e += 2)
          (d.x = a[e] - p), (d.y = a[e + 1] - n), (h.x = a[e + 2] - p), (h.y = a[e + 3] - n), f && ((d = r.project(d, g)), (h = r.project(h, g))), (h.x - d.x) * (c.y - d.y) > (c.x - d.x) * (h.y - d.y) && this._triangle(b, d, h, c);
        b.closePath();
        b.fill();
      },
    },
  ...
  t.onAdd = function (b) {
    ...
    b.on({ move: this.onMove, moveend: this.onMoveEnd, zoomstart: this.onZoomStart, zoomend: this.onZoomEnd, resize: this.onResize, viewreset: this.onViewReset, click: this.onClick }, this);
  ...
  t.onRemove = function () {
    ...
    b.off({ move: this.onMove, moveend: this.onMoveEnd, zoomstart: this.onZoomStart, zoomend: this.onZoomEnd, resize: this.onResize, viewreset: this.onViewReset, click: this.onClick }, this);
